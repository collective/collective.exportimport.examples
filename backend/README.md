# collective.eximportimport.examples
...
Install collective.eximportimport.examples with uv.

```shell
uv add collective.eximportimport.examples
```
...
- [Issue tracker](https://github.com/collective/migration-example-project/issues)
- [Source code](https://github.com/collective/migration-example-project/)
...
1.  Clone this repository.
    ...
    cd migration-example-project/backend
    ```
...
Generated from the [`cookieplone-templates`  template](https://github.com/plone/cookieplone-templates/tree/main/) on 2025-09-10 09:59:23.. A special thanks to all contributors and supporters!
