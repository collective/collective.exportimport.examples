...
# Migration example project build configuration file
...
project = "Migration example project"
...
linkcheck_ignore = [
    ...
    r"https://github.com/collective/migrationexampleproject/issues/new",  # requires auth
...
html_theme_options = {
    ...
    "icon_links": [
        {
            "name": "GitHub",
            "url": "https://github.com/collective/migrationexampleproject",
    ...
    "logo": {
        "text": "Migration example project",
    },
    "navigation_with_keys": True,
    "path_to_docs": "docs/docs",
    "repository_branch": "main",
    "repository_url": "https://github.com/collective/migrationexampleproject",
...
# html_context = {
#     "edit_page_url_template": "https://github.com/collective/migrationexampleproject/edit/main/docs/",
# }
...
ogp_site_name = "Migration example project Documentation"
ogp_type = "website"
...
htmlhelp_basename = "Migration example projectDocumentation"
...
latex_documents = [
    (
        "index",
        "Migration example projectDocumentation.tex",
        "Migration example project Documentation",
